...
I wrote some code that helped efficiently performing the lab. Based on the air temperature, composition of the air, humidity, air pressure, temperature of the room, and the dimensions of the rooms we made theoreical predictions as to what frequencies we expected to measure in our experiment. Calculating for a rectangular room was simple
```python
